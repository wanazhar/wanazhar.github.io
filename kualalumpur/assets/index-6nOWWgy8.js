...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Cp(i,e,t){const n=new Float32Array(ci),a=new R(0,1,0);return new kn({name:"SphericalGaussianBlur",defines:{n:ci,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:a}},vertexShader:fr(),fragmentShader:`
...
`)}function Lm(i,e){let t;switch(e){case fd:t="Linear";break;case pd:t="Reinhard";break;case md:t="Cineon";break;case Kl:t="ACESFilmic";break;case gd:t="AgX";break;case _d:t="Neutral";break;case xd:t="Custom";break;default:Ie("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const qa=new R;function Dm(){$e.getLuminanceCoefficients(qa);const i=qa.x.toFixed(4),e=qa.y.toFixed(4),t=qa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+f);const T=E+m+s,w=E+f+o,D=bl(a,a.VERTEX_SHADER,T),b=bl(a,a.FRAGMENT_SHADER,w);a.attachShader(_,D),a.attachShader(_,b),t.index0AttributeName!==void 0?a.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&a.bindAttribLocation(_,0,"position"),a.linkProgram(_);function P(I){if(i.debug.checkShaderErrors){const k=a.getProgramInfoLog(_)||"",G=a.getShaderInfoLog(D)||"",K=a.getShaderInfoLog(b)||"",V=k.trim(),j=G.trim(),ee=K.trim();let H=!0,ie=!0;if(a.getProgramParameter(_,a.LINK_STATUS)===!1)if(H=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(a,_,D,b);else{const re=Tl(a,D,"vertex"),Me=Tl(a,b,"fragment");gt("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(_,a.VALIDATE_STATUS)+`
...
Program Info Log: `+V+`
`+re+`
`+Me)}else V!==""?Ie("WebGLProgram: Program Info Log:",V):(j===""||ee==="")&&(ie=!1);ie&&(I.diagnostics={runnable:H,programLog:V,vertexShader:{log:j,prefix:m},fragmentShader:{log:ee,prefix:f}})}a.deleteShader(D),a.deleteShader(b),F=new Qa(a,_),M=Nm(a,_)}let F;this.getUniforms=function(){return F===void 0&&P(this),F};let M;this.getAttributes=function(){return M===void 0&&P(this),M};let y=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return y===!1&&(y=a.getProgramParameter(_,wm)),y},this.destroy=function(){n.releaseStatesOfProgram(this),a.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Am++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=D,this.fragmentShader=b,this}let qm=0;class Ym{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,a=this._getShaderStage(t),r=this._getShaderStage(n),s=this._getShaderCacheForMaterial(e);return s.has(a)===!1&&(s.add(a),a.usedTimes++),s.has(r)===!1&&(s.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new jm(e),t.set(e,n)),n}}class jm{constructor(e){this.id=qm++,this.code=e,this.usedTimes=0}}function $m(i,e,t,n,a,r,s){const o=new ac,l=new Ym,c=new Set,d=[],h=a.logarithmicDepthBuffer,u=a.vertexTextures;let p=a.precision;const x={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(M){return c.add(M),M===0?"uv":`uv${M}`}function m(M,y,I,k,G){const K=k.fog,V=G.geometry,j=M.isMeshStandardMaterial?k.environment:null,ee=(M.isMeshStandardMaterial?t:e).get(M.envMap||j),H=ee&&ee.mapping===dr?ee.image.height:null,ie=x[M.type];M.precision!==null&&(p=a.getMaxPrecision(M.precision),p!==M.precision&&Ie("WebGLProgram.getParameters:",M.precision,"not supported, using",p,"instead."));const re=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Me=re!==void 0?re.length:0;let Ge=0;V.morphAttributes.position!==void 0&&(Ge=1),V.morphAttributes.normal!==void 0&&(Ge=2),V.morphAttributes.color!==void 0&&(Ge=3);let qe,et,tt,q;if(ie){const nt=xn[ie];qe=nt.vertexShader,et=nt.fragmentShader}else qe=M.vertexShader,et=M.fragmentShader,l.update(M),tt=l.getVertexShaderID(M),q=l.getFragmentShaderID(M);const J=i.getRenderTarget(),me=i.state.buffers.depth.getReversed(),Le=G.isInstancedMesh===!0,ye=G.isBatchedMesh===!0,Ve=!!M.map,Je=!!M.matcap,Fe=!!ee,ot=!!M.aoMap,C=!!M.lightMap,ke=!!M.bumpMap,He=!!M.normalMap,Qe=!!M.displacementMap,pe=!!M.emissiveMap,Ye=!!M.metalnessMap,be=!!M.roughnessMap,De=M.anisotropy>0,S=M.clearcoat>0,g=M.dispersion>0,B=M.iridescence>0,Y=M.sheen>0,Q=M.transmission>0,A=De&&!!M.anisotropyMap,X=S&&!!M.clearcoatMap,$=S&&!!M.clearcoatNormalMap,le=S&&!!M.clearcoatRoughnessMap,ce=B&&!!M.iridescenceMap,W=B&&!!M.iridescenceThicknessMap,te=Y&&!!M.sheenColorMap,Ee=Y&&!!M.sheenRoughnessMap,Se=!!M.specularMap,ue=!!M.specularColorMap,Ae=!!M.specularIntensityMap,L=Q&&!!M.transmissionMap,de=Q&&!!M.thicknessMap,se=!!M.gradientMap,oe=!!M.alphaMap,ne=M.alphaTest>0,Z=!!M.alphaHash,_e=!!M.extensions;let Ne=$n;M.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(Ne=i.toneMapping);const ct={shaderID:ie,shaderType:M.type,shaderName:M.name,vertexShader:qe,fragmentShader:et,defines:M.defines,customVertexShaderID:tt,customFragmentShaderID:q,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:p,batching:ye,batchingColor:ye&&G._colorsTexture!==null,instancing:Le,instancingColor:Le&&G.instanceColor!==null,instancingMorph:Le&&G.morphTexture!==null,supportsVertexTextures:u,outputColorSpace:J===null?i.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:Hi,alphaToCoverage:!!M.alphaToCoverage,map:Ve,matcap:Je,envMap:Fe,envMapMode:Fe&&ee.mapping,envMapCubeUVHeight:H,aoMap:ot,lightMap:C,bumpMap:ke,normalMap:He,displacementMap:u&&Qe,emissiveMap:pe,normalMapObjectSpace:He&&M.normalMapType===bd,normalMapTangentSpace:He&&M.normalMapType===ec,metalnessMap:Ye,roughnessMap:be,anisotropy:De,anisotropyMap:A,clearcoat:S,clearcoatMap:X,clearcoatNormalMap:$,clearcoatRoughnessMap:le,dispersion:g,iridescence:B,iridescenceMap:ce,iridescenceThicknessMap:W,sheen:Y,sheenColorMap:te,sheenRoughnessMap:Ee,specularMap:Se,specularColorMap:ue,specularIntensityMap:Ae,transmission:Q,transmissionMap:L,thicknessMap:de,gradientMap:se,opaque:M.transparent===!1&&M.blending===Bi&&M.alphaToCoverage===!1,alphaMap:oe,alphaTest:ne,alphaHash:Z,combine:M.combine,mapUv:Ve&&_(M.map.channel),aoMapUv:ot&&_(M.aoMap.channel),lightMapUv:C&&_(M.lightMap.channel),bumpMapUv:ke&&_(M.bumpMap.channel),normalMapUv:He&&_(M.normalMap.channel),displacementMapUv:Qe&&_(M.displacementMap.channel),emissiveMapUv:pe&&_(M.emissiveMap.channel),metalnessMapUv:Ye&&_(M.metalnessMap.channel),roughnessMapUv:be&&_(M.roughnessMap.channel),anisotropyMapUv:A&&_(M.anisotropyMap.channel),clearcoatMapUv:X&&_(M.clearcoatMap.channel),clearcoatNormalMapUv:$&&_(M.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:le&&_(M.clearcoatRoughnessMap.channel),iridescenceMapUv:ce&&_(M.iridescenceMap.channel),iridescenceThicknessMapUv:W&&_(M.iridescenceThicknessMap.channel),sheenColorMapUv:te&&_(M.sheenColorMap.channel),sheenRoughnessMapUv:Ee&&_(M.sheenRoughnessMap.channel),specularMapUv:Se&&_(M.specularMap.channel),specularColorMapUv:ue&&_(M.specularColorMap.channel),specularIntensityMapUv:Ae&&_(M.specularIntensityMap.channel),transmissionMapUv:L&&_(M.transmissionMap.channel),thicknessMapUv:de&&_(M.thicknessMap.channel),alphaMapUv:oe&&_(M.alphaMap.channel),vertexTangents:!!V.attributes.tangent&&(He||De),vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,pointsUvs:G.isPoints===!0&&!!V.attributes.uv&&(Ve||oe),fog:!!K,useFog:M.fog===!0,fogExp2:!!K&&K.isFogExp2,flatShading:M.flatShading===!0&&M.wireframe===!1,sizeAttenuation:M.sizeAttenuation===!0,logarithmicDepthBuffer:h,reversedDepthBuffer:me,skinning:G.isSkinnedMesh===!0,morphTargets:V.morphAttributes.position!==void 0,morphNormals:V.morphAttributes.normal!==void 0,morphColors:V.morphAttributes.color!==void 0,morphTargetsCount:Me,morphTextureStride:Ge,numDirLights:y.directional.length,numPointLights:y.point.length,numSpotLights:y.spot.length,numSpotLightMaps:y.spotLightMap.length,numRectAreaLights:y.rectArea.length,numHemiLights:y.hemi.length,numDirLightShadows:y.directionalShadowMap.length,numPointLightShadows:y.pointShadowMap.length,numSpotLightShadows:y.spotShadowMap.length,numSpotLightShadowsWithMaps:y.numSpotLightShadowsWithMaps,numLightProbes:y.numLightProbes,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:M.dithering,shadowMapEnabled:i.shadowMap.enabled&&I.length>0,shadowMapType:i.shadowMap.type,toneMapping:Ne,decodeVideoTexture:Ve&&M.map.isVideoTexture===!0&&$e.getTransfer(M.map.colorSpace)===at,decodeVideoTextureEmissive:pe&&M.emissiveMap.isVideoTexture===!0&&$e.getTransfer(M.emissiveMap.colorSpace)===at,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===Pn,flipSided:M.side===Xt,useDepthPacking:M.depthPacking>=0,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionClipCullDistance:_e&&M.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(_e&&M.extensions.multiDraw===!0||ye)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:M.customProgramCacheKey()};return ct.vertexUv1s=c.has(1),ct.vertexUv2s=c.has(2),ct.vertexUv3s=c.has(3),c.clear(),ct}function f(M){const y=[];if(M.shaderID?y.push(M.shaderID):(y.push(M.customVertexShaderID),y.push(M.customFragmentShaderID)),M.defines!==void 0)for(const I in M.defines)y.push(I),y.push(M.defines[I]);return M.isRawShaderMaterial===!1&&(E(y,M),T(y,M),y.push(i.outputColorSpace)),y.push(M.customProgramCacheKey),y.join()}function E(M,y){M.push(y.precision),M.push(y.outputColorSpace),M.push(y.envMapMode),M.push(y.envMapCubeUVHeight),M.push(y.mapUv),M.push(y.alphaMapUv),M.push(y.lightMapUv),M.push(y.aoMapUv),M.push(y.bumpMapUv),M.push(y.normalMapUv),M.push(y.displacementMapUv),M.push(y.emissiveMapUv),M.push(y.metalnessMapUv),M.push(y.roughnessMapUv),M.push(y.anisotropyMapUv),M.push(y.clearcoatMapUv),M.push(y.clearcoatNormalMapUv),M.push(y.clearcoatRoughnessMapUv),M.push(y.iridescenceMapUv),M.push(y.iridescenceThicknessMapUv),M.push(y.sheenColorMapUv),M.push(y.sheenRoughnessMapUv),M.push(y.specularMapUv),M.push(y.specularColorMapUv),M.push(y.specularIntensityMapUv),M.push(y.transmissionMapUv),M.push(y.thicknessMapUv),M.push(y.combine),M.push(y.fogExp2),M.push(y.sizeAttenuation),M.push(y.morphTargetsCount),M.push(y.morphAttributeCount),M.push(y.numDirLights),M.push(y.numPointLights),M.push(y.numSpotLights),M.push(y.numSpotLightMaps),M.push(y.numHemiLights),M.push(y.numRectAreaLights),M.push(y.numDirLightShadows),M.push(y.numPointLightShadows),M.push(y.numSpotLightShadows),M.push(y.numSpotLightShadowsWithMaps),M.push(y.numLightProbes),M.push(y.shadowMapType),M.push(y.toneMapping),M.push(y.numClippingPlanes),M.push(y.numClipIntersection),M.push(y.depthPacking)}function T(M,y){o.disableAll(),y.supportsVertexTextures&&o.enable(0),y.instancing&&o.enable(1),y.instancingColor&&o.enable(2),y.instancingMorph&&o.enable(3),y.matcap&&o.enable(4),y.envMap&&o.enable(5),y.normalMapObjectSpace&&o.enable(6),y.normalMapTangentSpace&&o.enable(7),y.clearcoat&&o.enable(8),y.iridescence&&o.enable(9),y.alphaTest&&o.enable(10),y.vertexColors&&o.enable(11),y.vertexAlphas&&o.enable(12),y.vertexUv1s&&o.enable(13),y.vertexUv2s&&o.enable(14),y.vertexUv3s&&o.enable(15),y.vertexTangents&&o.enable(16),y.anisotropy&&o.enable(17),y.alphaHash&&o.enable(18),y.batching&&o.enable(19),y.dispersion&&o.enable(20),y.batchingColor&&o.enable(21),y.gradientMap&&o.enable(22),M.push(o.mask),o.disableAll(),y.fog&&o.enable(0),y.useFog&&o.enable(1),y.flatShading&&o.enable(2),y.logarithmicDepthBuffer&&o.enable(3),y.reversedDepthBuffer&&o.enable(4),y.skinning&&o.enable(5),y.morphTargets&&o.enable(6),y.morphNormals&&o.enable(7),y.morphColors&&o.enable(8),y.premultipliedAlpha&&o.enable(9),y.shadowMapEnabled&&o.enable(10),y.doubleSided&&o.enable(11),y.flipSided&&o.enable(12),y.useDepthPacking&&o.enable(13),y.dithering&&o.enable(14),y.transmission&&o.enable(15),y.sheen&&o.enable(16),y.opaque&&o.enable(17),y.pointsUvs&&o.enable(18),y.decodeVideoTexture&&o.enable(19),y.decodeVideoTextureEmissive&&o.enable(20),y.alphaToCoverage&&o.enable(21),M.push(o.mask)}function w(M){const y=x[M.type];let I;if(y){const k=xn[y];I=uh.clone(k.uniforms)}else I=M.uniforms;return I}function D(M,y){let I;for(let k=0,G=d.length;k<G;k++){const K=d[k];if(K.cacheKey===y){I=K,++I.usedTimes;break}}return I===void 0&&(I=new Km(i,y,M,r),d.push(I)),I}function b(M){if(--M.usedTimes===0){const y=d.indexOf(M);d[y]=d[d.length-1],d.pop(),M.destroy()}}function P(M){l.remove(M)}function F(){l.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:w,acquireProgram:D,releaseProgram:b,releaseShaderCache:P,programs:d,dispose:F}}function Zm(){let i=new WeakMap;function e(s){return i.has(s)}function t(s){let o=i.get(s);return o===void 0&&(o={},i.set(s,o)),o}function n(s){i.delete(s)}function a(s,o,l){i.get(s)[o]=l}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:a,dispose:r}}function Jm(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Rl(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Pl(){const i=[];let e=0;const t=[],n=[],a=[];function r(){e=0,t.length=0,n.length=0,a.length=0}function s(h,u,p,x,_,m){let f=i[e];return f===void 0?(f={id:h.id,object:h,geometry:u,material:p,groupOrder:x,renderOrder:h.renderOrder,z:_,group:m},i[e]=f):(f.id=h.id,f.object=h,f.geometry=u,f.material=p,f.groupOrder=x,f.renderOrder=h.renderOrder,f.z=_,f.group=m),e++,f}function o(h,u,p,x,_,m){const f=s(h,u,p,x,_,m);p.transmission>0?n.push(f):p.transparent===!0?a.push(f):t.push(f)}function l(h,u,p,x,_,m){const f=s(h,u,p,x,_,m);p.transmission>0?n.unshift(f):p.transparent===!0?a.unshift(f):t.unshift(f)}function c(h,u){t.length>1&&t.sort(h||Jm),n.length>1&&n.sort(u||Rl),a.length>1&&a.sort(u||Rl)}function d(){for(let h=e,u=i.length;h<u;h++){const p=i[h];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:a,init:r,push:o,unshift:l,finish:d,sort:c}}function Qm(){let i=new WeakMap;function e(n,a){const r=i.get(n);let s;return r===void 0?(s=new Pl,i.set(n,[s])):a>=r.length?(s=new Pl,r.push(s)):s=r[a],s}function t(){i=new WeakMap}return{get:e,dispose:t}}function e0(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new R,color:new Xe};break;case"SpotLight":t={position:new R,direction:new R,color:new Xe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new R,color:new Xe,distance:0,decay:0};break;case"HemisphereLight":t={direction:new R,skyColor:new Xe,groundColor:new Xe};break;case"RectAreaLight":t={color:new Xe,position:new R,halfWidth:new R,halfHeight:new R};break}return i[e.id]=t,t}}}function t0(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ue};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ue};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ue,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let n0=0;function i0(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function a0(i){const e=new e0,t=t0(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new R);const a=new R,r=new st,s=new st;function o(c){let d=0,h=0,u=0;for(let M=0;M<9;M++)n.probe[M].set(0,0,0);let p=0,x=0,_=0,m=0,f=0,E=0,T=0,w=0,D=0,b=0,P=0;c.sort(i0);for(let M=0,y=c.length;M<y;M++){const I=c[M],k=I.color,G=I.intensity,K=I.distance,V=I.shadow&&I.shadow.map?I.shadow.map.texture:null;if(I.isAmbientLight)d+=k.r*G,h+=k.g*G,u+=k.b*G;else if(I.isLightProbe){for(let j=0;j<9;j++)n.probe[j].addScaledVector(I.sh.coefficients[j],G);P++}else if(I.isDirectionalLight){const j=e.get(I);if(j.color.copy(I.color).multiplyScalar(I.intensity),I.castShadow){const ee=I.shadow,H=t.get(I);H.shadowIntensity=ee.intensity,H.shadowBias=ee.bias,H.shadowNormalBias=ee.normalBias,H.shadowRadius=ee.radius,H.shadowMapSize=ee.mapSize,n.directionalShadow[p]=H,n.directionalShadowMap[p]=V,n.directionalShadowMatrix[p]=I.shadow.matrix,E++}n.directional[p]=j,p++}else if(I.isSpotLight){const j=e.get(I);j.position.setFromMatrixPosition(I.matrixWorld),j.color.copy(k).multiplyScalar(G),j.distance=K,j.coneCos=Math.cos(I.angle),j.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),j.decay=I.decay,n.spot[_]=j;const ee=I.shadow;if(I.map&&(n.spotLightMap[D]=I.map,D++,ee.updateMatrices(I),I.castShadow&&b++),n.spotLightMatrix[_]=ee.matrix,I.castShadow){const H=t.get(I);H.shadowIntensity=ee.intensity,H.shadowBias=ee.bias,H.shadowNormalBias=ee.normalBias,H.shadowRadius=ee.radius,H.shadowMapSize=ee.mapSize,n.spotShadow[_]=H,n.spotShadowMap[_]=V,w++}_++}else if(I.isRectAreaLight){const j=e.get(I);j.color.copy(k).multiplyScalar(G),j.halfWidth.set(I.width*.5,0,0),j.halfHeight.set(0,I.height*.5,0),n.rectArea[m]=j,m++}else if(I.isPointLight){const j=e.get(I);if(j.color.copy(I.color).multiplyScalar(I.intensity),j.distance=I.distance,j.decay=I.decay,I.castShadow){const ee=I.shadow,H=t.get(I);H.shadowIntensity=ee.intensity,H.shadowBias=ee.bias,H.shadowNormalBias=ee.normalBias,H.shadowRadius=ee.radius,H.shadowMapSize=ee.mapSize,H.shadowCameraNear=ee.camera.near,H.shadowCameraFar=ee.camera.far,n.pointShadow[x]=H,n.pointShadowMap[x]=V,n.pointShadowMatrix[x]=I.shadow.matrix,T++}n.point[x]=j,x++}else if(I.isHemisphereLight){const j=e.get(I);j.skyColor.copy(I.color).multiplyScalar(G),j.groundColor.copy(I.groundColor).multiplyScalar(G),n.hemi[f]=j,f++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=he.LTC_FLOAT_1,n.rectAreaLTC2=he.LTC_FLOAT_2):(n.rectAreaLTC1=he.LTC_HALF_1,n.rectAreaLTC2=he.LTC_HALF_2)),n.ambient[0]=d,n.ambient[1]=h,n.ambient[2]=u;const F=n.hash;(F.directionalLength!==p||F.pointLength!==x||F.spotLength!==_||F.rectAreaLength!==m||F.hemiLength!==f||F.numDirectionalShadows!==E||F.numPointShadows!==T||F.numSpotShadows!==w||F.numSpotMaps!==D||F.numLightProbes!==P)&&(n.directional.length=p,n.spot.length=_,n.rectArea.length=m,n.point.length=x,n.hemi.length=f,n.directionalShadow.length=E,n.directionalShadowMap.length=E,n.pointShadow.length=T,n.pointShadowMap.length=T,n.spotShadow.length=w,n.spotShadowMap.length=w,n.directionalShadowMatrix.length=E,n.pointShadowMatrix.length=T,n.spotLightMatrix.length=w+D-b,n.spotLightMap.length=D,n.numSpotLightShadowsWithMaps=b,n.numLightProbes=P,F.directionalLength=p,F.pointLength=x,F.spotLength=_,F.rectAreaLength=m,F.hemiLength=f,F.numDirectionalShadows=E,F.numPointShadows=T,F.numSpotShadows=w,F.numSpotMaps=D,F.numLightProbes=P,n.version=n0++)}function l(c,d){let h=0,u=0,p=0,x=0,_=0;const m=d.matrixWorldInverse;for(let f=0,E=c.length;f<E;f++){const T=c[f];if(T.isDirectionalLight){const w=n.directional[h];w.direction.setFromMatrixPosition(T.matrixWorld),a.setFromMatrixPosition(T.target.matrixWorld),w.direction.sub(a),w.direction.transformDirection(m),h++}else if(T.isSpotLight){const w=n.spot[p];w.position.setFromMatrixPosition(T.matrixWorld),w.position.applyMatrix4(m),w.direction.setFromMatrixPosition(T.matrixWorld),a.setFromMatrixPosition(T.target.matrixWorld),w.direction.sub(a),w.direction.transformDirection(m),p++}else if(T.isRectAreaLight){const w=n.rectArea[x];w.position.setFromMatrixPosition(T.matrixWorld),w.position.applyMatrix4(m),s.identity(),r.copy(T.matrixWorld),r.premultiply(m),s.extractRotation(r),w.halfWidth.set(T.width*.5,0,0),w.halfHeight.set(0,T.height*.5,0),w.halfWidth.applyMatrix4(s),w.halfHeight.applyMatrix4(s),x++}else if(T.isPointLight){const w=n.point[u];w.position.setFromMatrixPosition(T.matrixWorld),w.position.applyMatrix4(m),u++}else if(T.isHemisphereLight){const w=n.hemi[_];w.direction.setFromMatrixPosition(T.matrixWorld),w.direction.transformDirection(m),_++}}}return{setup:o,setupView:l,state:n}}function Ll(i){const e=new a0(i),t=[],n=[];function a(d){c.camera=d,t.length=0,n.length=0}function r(d){t.push(d)}function s(d){n.push(d)}function o(){e.setup(t)}function l(d){e.setupView(t,d)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:a,state:c,setupLights:o,setupLightsView:l,pushLight:r,pushShadow:s}}function r0(i){let e=new WeakMap;function t(a,r=0){const s=e.get(a);let o;return s===void 0?(o=new Ll(i),e.set(a,[o])):r>=s.length?(o=new Ll(i),s.push(o)):o=s[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const s0=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function l0(i,e,t){let n=new lo;const a=new Ue,r=new Ue,s=new xt,o=new wh({depthPacking:Md}),l=new Ah,c={},d=t.maxTextureSize,h={[Jn]:Xt,[Xt]:Jn,[Pn]:Pn},u=new kn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ue},radius:{value:4}},vertexShader:s0,fragmentShader:o0}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const x=new sn;x.setAttribute("position",new rn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Et(x,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Xl;let f=this.type;this.render=function(b,P,F){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;const M=i.getRenderTarget(),y=i.getActiveCubeFace(),I=i.getActiveMipmapLevel(),k=i.state;k.setBlending(Un),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const G=f!==Cn&&this.type===Cn,K=f===Cn&&this.type!==Cn;for(let V=0,j=b.length;V<j;V++){const ee=b[V],H=ee.shadow;if(H===void 0){Ie("WebGLShadowMap:",ee,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;a.copy(H.mapSize);const ie=H.getFrameExtents();if(a.multiply(ie),r.copy(H.mapSize),(a.x>d||a.y>d)&&(a.x>d&&(r.x=Math.floor(d/ie.x),a.x=r.x*ie.x,H.mapSize.x=r.x),a.y>d&&(r.y=Math.floor(d/ie.y),a.y=r.y*ie.y,H.mapSize.y=r.y)),H.map===null||G===!0||K===!0){const Me=this.type!==Cn?{minFilter:Zt,magFilter:Zt}:{};H.map!==null&&H.map.dispose(),H.map=new fi(a.x,a.y,Me),H.map.texture.name=ee.name+".shadowMap",H.camera.updateProjectionMatrix()}i.setRenderTarget(H.map),i.clear();const re=H.getViewportCount();for(let Me=0;Me<re;Me++){const Ge=H.getViewport(Me);s.set(r.x*Ge.x,r.y*Ge.y,r.x*Ge.z,r.y*Ge.w),k.viewport(s),H.updateMatrices(ee,Me),n=H.getFrustum(),w(P,F,H.camera,ee,this.type)}H.isPointLightShadow!==!0&&this.type===Cn&&E(H,F),H.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(M,y,I)};function E(b,P){const F=e.update(_);u.defines.VSM_SAMPLES!==b.blurSamples&&(u.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new fi(a.x,a.y)),u.uniforms.shadow_pass.value=b.map.texture,u.uniforms.resolution.value=b.mapSize,u.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(P,null,F,u,_,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(P,null,F,p,_,null)}function T(b,P,F,M){let y=null;const I=F.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(I!==void 0)y=I;else if(y=F.isPointLight===!0?l:o,i.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const k=y.uuid,G=P.uuid;let K=c[k];K===void 0&&(K={},c[k]=K);let V=K[G];V===void 0&&(V=y.clone(),K[G]=V,P.addEventListener("dispose",D)),y=V}if(y.visible=P.visible,y.wireframe=P.wireframe,M===Cn?y.side=P.shadowSide!==null?P.shadowSide:P.side:y.side=P.shadowSide!==null?P.shadowSide:h[P.side],y.alphaMap=P.alphaMap,y.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,y.map=P.map,y.clipShadows=P.clipShadows,y.clippingPlanes=P.clippingPlanes,y.clipIntersection=P.clipIntersection,y.displacementMap=P.displacementMap,y.displacementScale=P.displacementScale,y.displacementBias=P.displacementBias,y.wireframeLinewidth=P.wireframeLinewidth,y.linewidth=P.linewidth,F.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const k=i.properties.get(y);k.light=F}return y}function w(b,P,F,M,y){if(b.visible===!1)return;if(b.layers.test(P.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&y===Cn)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,b.matrixWorld);const G=e.update(b),K=b.material;if(Array.isArray(K)){const V=G.groups;for(let j=0,ee=V.length;j<ee;j++){const H=V[j],ie=K[H.materialIndex];if(ie&&ie.visible){const re=T(b,ie,M,y);b.onBeforeShadow(i,b,P,F,G,re,H),i.renderBufferDirect(F,null,G,re,b,H),b.onAfterShadow(i,b,P,F,G,re,H)}}}else if(K.visible){const V=T(b,K,M,y);b.onBeforeShadow(i,b,P,F,G,V,null),i.renderBufferDirect(F,null,G,V,b,null),b.onAfterShadow(i,b,P,F,G,V,null)}}const k=b.children;for(let G=0,K=k.length;G<K;G++)w(k[G],P,F,M,y)}function D(b){b.target.removeEventListener("dispose",D);for(const F in c){const M=c[F],y=b.target.uuid;y in M&&(M[y].dispose(),delete M[y])}}}const c0={[rs]:ss,[os]:ds,[ls]:hs,[zi]:cs,[ss]:rs,[ds]:os,[hs]:ls,[cs]:zi};function d0(i,e){function t(){let L=!1;const de=new xt;let se=null;const oe=new xt(0,0,0,0);return{setMask:function(ne){se!==ne&&!L&&(i.colorMask(ne,ne,ne,ne),se=ne)},setLocked:function(ne){L=ne},setClear:function(ne,Z,_e,Ne,ct){ct===!0&&(ne*=Ne,Z*=Ne,_e*=Ne),de.set(ne,Z,_e,Ne),oe.equals(de)===!1&&(i.clearColor(ne,Z,_e,Ne),oe.copy(de))},reset:function(){L=!1,se=null,oe.set(-1,0,0,0)}}}function n(){let L=!1,de=!1,se=null,oe=null,ne=null;return{setReversed:function(Z){if(de!==Z){const _e=e.get("EXT_clip_control");Z?_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.ZERO_TO_ONE_EXT):_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.NEGATIVE_ONE_TO_ONE_EXT),de=Z;const Ne=ne;ne=null,this.setClear(Ne)}},getReversed:function(){return de},setTest:function(Z){Z?J(i.DEPTH_TEST):me(i.DEPTH_TEST)},setMask:function(Z){se!==Z&&!L&&(i.depthMask(Z),se=Z)},setFunc:function(Z){if(de&&(Z=c0[Z]),oe!==Z){switch(Z){case rs:i.depthFunc(i.NEVER);break;case ss:i.depthFunc(i.ALWAYS);break;case os:i.depthFunc(i.LESS);break;case zi:i.depthFunc(i.LEQUAL);break;case ls:i.depthFunc(i.EQUAL);break;case cs:i.depthFunc(i.GEQUAL);break;case ds:i.depthFunc(i.GREATER);break;case hs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}oe=Z}},setLocked:function(Z){L=Z},setClear:function(Z){ne!==Z&&(de&&(Z=1-Z),i.clearDepth(Z),ne=Z)},reset:function(){L=!1,se=null,oe=null,ne=null,de=!1}}}function a(){let L=!1,de=null,se=null,oe=null,ne=null,Z=null,_e=null,Ne=null,ct=null;return{setTest:function(nt){L||(nt?J(i.STENCIL_TEST):me(i.STENCIL_TEST))},setMask:function(nt){de!==nt&&!L&&(i.stencilMask(nt),de=nt)},setFunc:function(nt,pn,on){(se!==nt||oe!==pn||ne!==on)&&(i.stencilFunc(nt,pn,on),se=nt,oe=pn,ne=on)},setOp:function(nt,pn,on){(Z!==nt||_e!==pn||Ne!==on)&&(i.stencilOp(nt,pn,on),Z=nt,_e=pn,Ne=on)},setLocked:function(nt){L=nt},setClear:function(nt){ct!==nt&&(i.clearStencil(nt),ct=nt)},reset:function(){L=!1,de=null,se=null,oe=null,ne=null,Z=null,_e=null,Ne=null,ct=null}}}const r=new t,s=new n,o=new a,l=new WeakMap,c=new WeakMap;let d={},h={},u=new WeakMap,p=[],x=null,_=!1,m=null,f=null,E=null,T=null,w=null,D=null,b=null,P=new Xe(0,0,0),F=0,M=!1,y=null,I=null,k=null,G=null,K=null;const V=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let j=!1,ee=0;const H=i.getParameter(i.VERSION);H.indexOf("WebGL")!==-1?(ee=parseFloat(/^WebGL (\d)/.exec(H)[1]),j=ee>=1):H.indexOf("OpenGL ES")!==-1&&(ee=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),j=ee>=2);let ie=null,re={};const Me=i.getParameter(i.SCISSOR_BOX),Ge=i.getParameter(i.VIEWPORT),qe=new xt().fromArray(Me),et=new xt().fromArray(Ge);function tt(L,de,se,oe){const ne=new Uint8Array(4),Z=i.createTexture();i.bindTexture(L,Z),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let _e=0;_e<se;_e++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(de,0,i.RGBA,1,1,oe,0,i.RGBA,i.UNSIGNED_BYTE,ne):i.texImage2D(de+_e,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ne);return Z}const q={};q[i.TEXTURE_2D]=tt(i.TEXTURE_2D,i.TEXTURE_2D,1),q[i.TEXTURE_CUBE_MAP]=tt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[i.TEXTURE_2D_ARRAY]=tt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),q[i.TEXTURE_3D]=tt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),J(i.DEPTH_TEST),s.setFunc(zi),ke(!1),He(Ro),J(i.CULL_FACE),ot(Un);function J(L){d[L]!==!0&&(i.enable(L),d[L]=!0)}function me(L){d[L]!==!1&&(i.disable(L),d[L]=!1)}function Le(L,de){return h[L]!==de?(i.bindFramebuffer(L,de),h[L]=de,L===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=de),L===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=de),!0):!1}function ye(L,de){let se=p,oe=!1;if(L){se=u.get(de),se===void 0&&(se=[],u.set(de,se));const ne=L.textures;if(se.length!==ne.length||se[0]!==i.COLOR_ATTACHMENT0){for(let Z=0,_e=ne.length;Z<_e;Z++)se[Z]=i.COLOR_ATTACHMENT0+Z;se.length=ne.length,oe=!0}}else se[0]!==i.BACK&&(se[0]=i.BACK,oe=!0);oe&&i.drawBuffers(se)}function Ve(L){return x!==L?(i.useProgram(L),x=L,!0):!1}const Je={[li]:i.FUNC_ADD,[Yc]:i.FUNC_SUBTRACT,[jc]:i.FUNC_REVERSE_SUBTRACT};Je[$c]=i.MIN,Je[Zc]=i.MAX;const Fe={[Jc]:i.ZERO,[Qc]:i.ONE,[ed]:i.SRC_COLOR,[is]:i.SRC_ALPHA,[sd]:i.SRC_ALPHA_SATURATE,[ad]:i.DST_COLOR,[nd]:i.DST_ALPHA,[td]:i.ONE_MINUS_SRC_COLOR,[as]:i.ONE_MINUS_SRC_ALPHA,[rd]:i.ONE_MINUS_DST_COLOR,[id]:i.ONE_MINUS_DST_ALPHA,[od]:i.CONSTANT_COLOR,[ld]:i.ONE_MINUS_CONSTANT_COLOR,[cd]:i.CONSTANT_ALPHA,[dd]:i.ONE_MINUS_CONSTANT_ALPHA};function ot(L,de,se,oe,ne,Z,_e,Ne,ct,nt){if(L===Un){_===!0&&(me(i.BLEND),_=!1);return}if(_===!1&&(J(i.BLEND),_=!0),L!==qc){if(L!==m||nt!==M){if((f!==li||w!==li)&&(i.blendEquation(i.FUNC_ADD),f=li,w=li),nt)switch(L){case Bi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Po:i.blendFunc(i.ONE,i.ONE);break;case Lo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Do:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:gt("WebGLState: Invalid blending: ",L);break}else switch(L){case Bi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Po:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Lo:gt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Do:gt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:gt("WebGLState: Invalid blending: ",L);break}E=null,T=null,D=null,b=null,P.set(0,0,0),F=0,m=L,M=nt}return}ne=ne||de,Z=Z||se,_e=_e||oe,(de!==f||ne!==w)&&(i.blendEquationSeparate(Je[de],Je[ne]),f=de,w=ne),(se!==E||oe!==T||Z!==D||_e!==b)&&(i.blendFuncSeparate(Fe[se],Fe[oe],Fe[Z],Fe[_e]),E=se,T=oe,D=Z,b=_e),(Ne.equals(P)===!1||ct!==F)&&(i.blendColor(Ne.r,Ne.g,Ne.b,ct),P.copy(Ne),F=ct),m=L,M=!1}function C(L,de){L.side===Pn?me(i.CULL_FACE):J(i.CULL_FACE);let se=L.side===Xt;de&&(se=!se),ke(se),L.blending===Bi&&L.transparent===!1?ot(Un):ot(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),s.setFunc(L.depthFunc),s.setTest(L.depthTest),s.setMask(L.depthWrite),r.setMask(L.colorWrite);const oe=L.stencilWrite;o.setTest(oe),oe&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),pe(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?J(i.SAMPLE_ALPHA_TO_COVERAGE):me(i.SAMPLE_ALPHA_TO_COVERAGE)}function ke(L){y!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),y=L)}function He(L){L!==Wc?(J(i.CULL_FACE),L!==I&&(L===Ro?i.cullFace(i.BACK):L===Xc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):me(i.CULL_FACE),I=L}function Qe(L){L!==k&&(j&&i.lineWidth(L),k=L)}function pe(L,de,se){L?(J(i.POLYGON_OFFSET_FILL),(G!==de||K!==se)&&(i.polygonOffset(de,se),G=de,K=se)):me(i.POLYGON_OFFSET_FILL)}function Ye(L){L?J(i.SCISSOR_TEST):me(i.SCISSOR_TEST)}function be(L){L===void 0&&(L=i.TEXTURE0+V-1),ie!==L&&(i.activeTexture(L),ie=L)}function De(L,de,se){se===void 0&&(ie===null?se=i.TEXTURE0+V-1:se=ie);let oe=re[se];oe===void 0&&(oe={type:void 0,texture:void 0},re[se]=oe),(oe.type!==L||oe.texture!==de)&&(ie!==se&&(i.activeTexture(se),ie=se),i.bindTexture(L,de||q[L]),oe.type=L,oe.texture=de)}function S(){const L=re[ie];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function g(){try{i.compressedTexImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function B(){try{i.compressedTexImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function Y(){try{i.texSubImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function Q(){try{i.texSubImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function A(){try{i.compressedTexSubImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function X(){try{i.compressedTexSubImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function $(){try{i.texStorage2D(...arguments)}catch(L){L("WebGLState:",L)}}function le(){try{i.texStorage3D(...arguments)}catch(L){L("WebGLState:",L)}}function ce(){try{i.texImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function W(){try{i.texImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function te(L){qe.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),qe.copy(L))}function Ee(L){et.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),et.copy(L))}function Se(L,de){let se=c.get(de);se===void 0&&(se=new WeakMap,c.set(de,se));let oe=se.get(L);oe===void 0&&(oe=i.getUniformBlockIndex(de,L.name),se.set(L,oe))}function ue(L,de){const oe=c.get(de).get(L);l.get(de)!==oe&&(i.uniformBlockBinding(de,oe,L.__bindingPointIndex),l.set(de,oe))}function Ae(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),s.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),d={},ie=null,re={},h={},u=new WeakMap,p=[],x=null,_=!1,m=null,f=null,E=null,T=null,w=null,D=null,b=null,P=new Xe(0,0,0),F=0,M=!1,y=null,I=null,k=null,G=null,K=null,qe.set(0,0,i.canvas.width,i.canvas.height),et.set(0,0,i.canvas.width,i.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:J,disable:me,bindFramebuffer:Le,drawBuffers:ye,useProgram:Ve,setBlending:ot,setMaterial:C,setFlipSided:ke,setCullFace:He,setLineWidth:Qe,setPolygonOffset:pe,setScissorTest:Ye,activeTexture:be,bindTexture:De,unbindTexture:S,compressedTexImage2D:g,compressedTexImage3D:B,texImage2D:ce,texImage3D:W,updateUBOMapping:Se,uniformBlockBinding:ue,texStorage2D:$,texStorage3D:le,texSubImage2D:Y,texSubImage3D:Q,compressedTexSubImage2D:A,compressedTexSubImage3D:X,scissor:te,viewport:Ee,reset:Ae}}function h0(i,e,t,n,a,r,s){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ue,d=new WeakMap;let h;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(S,g){return p?new OffscreenCanvas(S,g):sr("canvas")}function _(S,g,B){let Y=1;const Q=De(S);if((Q.width>B||Q.height>B)&&(Y=B/Math.max(Q.width,Q.height)),Y<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const A=Math.floor(Y*Q.width),X=Math.floor(Y*Q.height);h===void 0&&(h=x(A,X));const $=g?x(A,X):h;return $.width=A,$.height=X,$.getContext("2d").drawImage(S,0,0,A,X),Ie("WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+A+"x"+X+")."),$}else return"data"in S&&Ie("WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),S;return S}function m(S){return S.generateMipmaps}function f(S){i.generateMipmap(S)}function E(S){return S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?i.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(S,g,B,Y,Q=!1){if(S!==null){if(i[S]!==void 0)return i[S];Ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let A=g;if(g===i.RED&&(B===i.FLOAT&&(A=i.R32F),B===i.HALF_FLOAT&&(A=i.R16F),B===i.UNSIGNED_BYTE&&(A=i.R8)),g===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(A=i.R8UI),B===i.UNSIGNED_SHORT&&(A=i.R16UI),B===i.UNSIGNED_INT&&(A=i.R32UI),B===i.BYTE&&(A=i.R8I),B===i.SHORT&&(A=i.R16I),B===i.INT&&(A=i.R32I)),g===i.RG&&(B===i.FLOAT&&(A=i.RG32F),B===i.HALF_FLOAT&&(A=i.RG16F),B===i.UNSIGNED_BYTE&&(A=i.RG8)),g===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(A=i.RG8UI),B===i.UNSIGNED_SHORT&&(A=i.RG16UI),B===i.UNSIGNED_INT&&(A=i.RG32UI),B===i.BYTE&&(A=i.RG8I),B===i.SHORT&&(A=i.RG16I),B===i.INT&&(A=i.RG32I)),g===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(A=i.RGB8UI),B===i.UNSIGNED_SHORT&&(A=i.RGB16UI),B===i.UNSIGNED_INT&&(A=i.RGB32UI),B===i.BYTE&&(A=i.RGB8I),B===i.SHORT&&(A=i.RGB16I),B===i.INT&&(A=i.RGB32I)),g===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(A=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(A=i.RGBA16UI),B===i.UNSIGNED_INT&&(A=i.RGBA32UI),B===i.BYTE&&(A=i.RGBA8I),B===i.SHORT&&(A=i.RGBA16I),B===i.INT&&(A=i.RGBA32I)),g===i.RGB&&(B===i.UNSIGNED_INT_5_9_9_9_REV&&(A=i.RGB9_E5),B===i.UNSIGNED_INT_10F_11F_11F_REV&&(A=i.R11F_G11F_B10F)),g===i.RGBA){const X=Q?ir:$e.getTransfer(Y);B===i.FLOAT&&(A=i.RGBA32F),B===i.HALF_FLOAT&&(A=i.RGBA16F),B===i.UNSIGNED_BYTE&&(A=X===at?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT_4_4_4_4&&(A=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(A=i.RGB5_A1)}return(A===i.R16F||A===i.R32F||A===i.RG16F||A===i.RG32F||A===i.RGBA16F||A===i.RGBA32F)&&e.get("EXT_color_buffer_float"),A}function w(S,g){let B;return S?g===null||g===ui||g===pa?B=i.DEPTH24_STENCIL8:g===gn?B=i.DEPTH32F_STENCIL8:g===fa&&(B=i.DEPTH24_STENCIL8,Ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===ui||g===pa?B=i.DEPTH_COMPONENT24:g===gn?B=i.DEPTH_COMPONENT32F:g===fa&&(B=i.DEPTH_COMPONENT16),B}function D(S,g){return m(S)===!0||S.isFramebufferTexture&&S.minFilter!==Zt&&S.minFilter!==an?Math.log2(Math.max(g.width,g.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?g.mipmaps.length:1}function b(S){const g=S.target;g.removeEventListener("dispose",b),F(g),g.isVideoTexture&&d.delete(g)}function P(S){const g=S.target;g.removeEventListener("dispose",P),y(g)}function F(S){const g=n.get(S);if(g.__webglInit===void 0)return;const B=S.source,Y=u.get(B);if(Y){const Q=Y[g.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&M(S),Object.keys(Y).length===0&&u.delete(B)}n.remove(S)}function M(S){const g=n.get(S);i.deleteTexture(g.__webglTexture);const B=S.source,Y=u.get(B);delete Y[g.__cacheKey],s.memory.textures--}function y(S){const g=n.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),n.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(g.__webglFramebuffer[Y]))for(let Q=0;Q<g.__webglFramebuffer[Y].length;Q++)i.deleteFramebuffer(g.__webglFramebuffer[Y][Q]);else i.deleteFramebuffer(g.__webglFramebuffer[Y]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[Y])}else{if(Array.isArray(g.__webglFramebuffer))for(let Y=0;Y<g.__webglFramebuffer.length;Y++)i.deleteFramebuffer(g.__webglFramebuffer[Y]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let Y=0;Y<g.__webglColorRenderbuffer.length;Y++)g.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[Y]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const B=S.textures;for(let Y=0,Q=B.length;Y<Q;Y++){const A=n.get(B[Y]);A.__webglTexture&&(i.deleteTexture(A.__webglTexture),s.memory.textures--),n.remove(B[Y])}n.remove(S)}let I=0;function k(){I=0}function G(){const S=I;return S>=a.maxTextures&&Ie("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+a.maxTextures),I+=1,S}function K(S){const g=[];return g.push(S.wrapS),g.push(S.wrapT),g.push(S.wrapR||0),g.push(S.magFilter),g.push(S.minFilter),g.push(S.anisotropy),g.push(S.internalFormat),g.push(S.format),g.push(S.type),g.push(S.generateMipmaps),g.push(S.premultiplyAlpha),g.push(S.flipY),g.push(S.unpackAlignment),g.push(S.colorSpace),g.join()}function V(S,g){const B=n.get(S);if(S.isVideoTexture&&Ye(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&B.__version!==S.version){const Y=S.image;if(Y===null)Ie("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Ie("WebGLRenderer: Texture marked for update but image is incomplete");else{q(B,S,g);return}}else S.isExternalTexture&&(B.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+g)}function j(S,g){const B=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&B.__version!==S.version){q(B,S,g);return}else S.isExternalTexture&&(B.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+g)}function ee(S,g){const B=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&B.__version!==S.version){q(B,S,g);return}t.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+g)}function H(S,g){const B=n.get(S);if(S.version>0&&B.__version!==S.version){J(B,S,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+g)}const ie={[ps]:i.REPEAT,[Ln]:i.CLAMP_TO_EDGE,[ms]:i.MIRRORED_REPEAT},re={[Zt]:i.NEAREST,[vd]:i.NEAREST_MIPMAP_NEAREST,[Ta]:i.NEAREST_MIPMAP_LINEAR,[an]:i.LINEAR,[_r]:i.LINEAR_MIPMAP_NEAREST,[di]:i.LINEAR_MIPMAP_LINEAR},Me={[Sd]:i.NEVER,[Rd]:i.ALWAYS,[Td]:i.LESS,[tc]:i.LEQUAL,[Ed]:i.EQUAL,[Cd]:i.GEQUAL,[wd]:i.GREATER,[Ad]:i.NOTEQUAL};function Ge(S,g){if(g.type===gn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===an||g.magFilter===_r||g.magFilter===Ta||g.magFilter===di||g.minFilter===an||g.minFilter===_r||g.minFilter===Ta||g.minFilter===di)&&Ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,ie[g.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,ie[g.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,ie[g.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,re[g.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,re[g.minFilter]),g.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,Me[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Zt||g.minFilter!==Ta&&g.minFilter!==di||g.type===gn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");i.texParameterf(S,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,a.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function qe(S,g){let B=!1;S.__webglInit===void 0&&(S.__webglInit=!0,g.addEventListener("dispose",b));const Y=g.source;let Q=u.get(Y);Q===void 0&&(Q={},u.set(Y,Q));const A=K(g);if(A!==S.__cacheKey){Q[A]===void 0&&(Q[A]={texture:i.createTexture(),usedTimes:0},s.memory.textures++,B=!0),Q[A].usedTimes++;const X=Q[S.__cacheKey];X!==void 0&&(Q[S.__cacheKey].usedTimes--,X.usedTimes===0&&M(g)),S.__cacheKey=A,S.__webglTexture=Q[A].texture}return B}function et(S,g,B){return Math.floor(Math.floor(S/B)/g)}function tt(S,g,B,Y){const A=S.updateRanges;if(A.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,B,Y,g.data);else{A.sort((W,te)=>W.start-te.start);let X=0;for(let W=1;W<A.length;W++){const te=A[X],Ee=A[W],Se=te.start+te.count,ue=et(Ee.start,g.width,4),Ae=et(te.start,g.width,4);Ee.start<=Se+1&&ue===Ae&&et(Ee.start+Ee.count-1,g.width,4)===ue?te.count=Math.max(te.count,Ee.start+Ee.count-te.start):(++X,A[X]=Ee)}A.length=X+1;const $=i.getParameter(i.UNPACK_ROW_LENGTH),le=i.getParameter(i.UNPACK_SKIP_PIXELS),ce=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let W=0,te=A.length;W<te;W++){const Ee=A[W],Se=Math.floor(Ee.start/4),ue=Math.ceil(Ee.count/4),Ae=Se%g.width,L=Math.floor(Se/g.width),de=ue,se=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ae),i.pixelStorei(i.UNPACK_SKIP_ROWS,L),t.texSubImage2D(i.TEXTURE_2D,0,Ae,L,de,se,B,Y,g.data)}S.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,$),i.pixelStorei(i.UNPACK_SKIP_PIXELS,le),i.pixelStorei(i.UNPACK_SKIP_ROWS,ce)}}function q(S,g,B){let Y=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(Y=i.TEXTURE_3D);const Q=qe(S,g),A=g.source;t.bindTexture(Y,S.__webglTexture,i.TEXTURE0+B);const X=n.get(A);if(A.version!==X.__version||Q===!0){t.activeTexture(i.TEXTURE0+B);const $=$e.getPrimaries($e.workingColorSpace),le=g.colorSpace===Kn?null:$e.getPrimaries(g.colorSpace),ce=g.colorSpace===Kn||$===le?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ce);let W=_(g.image,!1,a.maxTextureSize);W=be(g,W);const te=r.convert(g.format,g.colorSpace),Ee=r.convert(g.type);let Se=T(g.internalFormat,te,Ee,g.colorSpace,g.isVideoTexture);Ge(Y,g);let ue;const Ae=g.mipmaps,L=g.isVideoTexture!==!0,de=X.__version===void 0||Q===!0,se=A.dataReady,oe=D(g,W);if(g.isDepthTexture)Se=w(g.format===xa,g.type),de&&(L?t.texStorage2D(i.TEXTURE_2D,1,Se,W.width,W.height):t.texImage2D(i.TEXTURE_2D,0,Se,W.width,W.height,0,te,Ee,null));else if(g.isDataTexture)if(Ae.length>0){L&&de&&t.texStorage2D(i.TEXTURE_2D,oe,Se,Ae[0].width,Ae[0].height);for(let ne=0,Z=Ae.length;ne<Z;ne++)ue=Ae[ne],L?se&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,ue.width,ue.height,te,Ee,ue.data):t.texImage2D(i.TEXTURE_2D,ne,Se,ue.width,ue.height,0,te,Ee,ue.data);g.generateMipmaps=!1}else L?(de&&t.texStorage2D(i.TEXTURE_2D,oe,Se,W.width,W.height),se&&tt(g,W,te,Ee)):t.texImage2D(i.TEXTURE_2D,0,Se,W.width,W.height,0,te,Ee,W.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){L&&de&&t.texStorage3D(i.TEXTURE_2D_ARRAY,oe,Se,Ae[0].width,Ae[0].height,W.depth);for(let ne=0,Z=Ae.length;ne<Z;ne++)if(ue=Ae[ne],g.format!==fn)if(te!==null)if(L){if(se)if(g.layerUpdates.size>0){const _e=ll(ue.width,ue.height,g.format,g.type);for(const Ne of g.layerUpdates){const ct=ue.data.subarray(Ne*_e/ue.data.BYTES_PER_ELEMENT,(Ne+1)*_e/ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,Ne,ue.width,ue.height,1,te,ct)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,0,ue.width,ue.height,W.depth,te,ue.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ne,Se,ue.width,ue.height,W.depth,0,ue.data,0,0);else Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?se&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,0,ue.width,ue.height,W.depth,te,Ee,ue.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ne,Se,ue.width,ue.height,W.depth,0,te,Ee,ue.data)}else{L&&de&&t.texStorage2D(i.TEXTURE_2D,oe,Se,Ae[0].width,Ae[0].height);for(let ne=0,Z=Ae.length;ne<Z;ne++)ue=Ae[ne],g.format!==fn?te!==null?L?se&&t.compressedTexSubImage2D(i.TEXTURE_2D,ne,0,0,ue.width,ue.height,te,ue.data):t.compressedTexImage2D(i.TEXTURE_2D,ne,Se,ue.width,ue.height,0,ue.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?se&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,ue.width,ue.height,te,Ee,ue.data):t.texImage2D(i.TEXTURE_2D,ne,Se,ue.width,ue.height,0,te,Ee,ue.data)}else if(g.isDataArrayTexture)if(L){if(de&&t.texStorage3D(i.TEXTURE_2D_ARRAY,oe,Se,W.width,W.height,W.depth),se)if(g.layerUpdates.size>0){const ne=ll(W.width,W.height,g.format,g.type);for(const Z of g.layerUpdates){const _e=W.data.subarray(Z*ne/W.data.BYTES_PER_ELEMENT,(Z+1)*ne/W.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,W.width,W.height,1,te,Ee,_e)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,W.width,W.height,W.depth,te,Ee,W.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Se,W.width,W.height,W.depth,0,te,Ee,W.data);else if(g.isData3DTexture)L?(de&&t.texStorage3D(i.TEXTURE_3D,oe,Se,W.width,W.height,W.depth),se&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,W.width,W.height,W.depth,te,Ee,W.data)):t.texImage3D(i.TEXTURE_3D,0,Se,W.width,W.height,W.depth,0,te,Ee,W.data);else if(g.isFramebufferTexture){if(de)if(L)t.texStorage2D(i.TEXTURE_2D,oe,Se,W.width,W.height);else{let ne=W.width,Z=W.height;for(let _e=0;_e<oe;_e++)t.texImage2D(i.TEXTURE_2D,_e,Se,ne,Z,0,te,Ee,null),ne>>=1,Z>>=1}}else if(Ae.length>0){if(L&&de){const ne=De(Ae[0]);t.texStorage2D(i.TEXTURE_2D,oe,Se,ne.width,ne.height)}for(let ne=0,Z=Ae.length;ne<Z;ne++)ue=Ae[ne],L?se&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,te,Ee,ue):t.texImage2D(i.TEXTURE_2D,ne,Se,te,Ee,ue);g.generateMipmaps=!1}else if(L){if(de){const ne=De(W);t.texStorage2D(i.TEXTURE_2D,oe,Se,ne.width,ne.height)}se&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,te,Ee,W)}else t.texImage2D(i.TEXTURE_2D,0,Se,te,Ee,W);m(g)&&f(Y),X.__version=A.version,g.onUpdate&&g.onUpdate(g)}S.__version=g.version}function J(S,g,B){if(g.image.length!==6)return;const Y=qe(S,g),Q=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+B);const A=n.get(Q);if(Q.version!==A.__version||Y===!0){t.activeTexture(i.TEXTURE0+B);const X=$e.getPrimaries($e.workingColorSpace),$=g.colorSpace===Kn?null:$e.getPrimaries(g.colorSpace),le=g.colorSpace===Kn||X===$?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,le);const ce=g.isCompressedTexture||g.image[0].isCompressedTexture,W=g.image[0]&&g.image[0].isDataTexture,te=[];for(let Z=0;Z<6;Z++)!ce&&!W?te[Z]=_(g.image[Z],!0,a.maxCubemapSize):te[Z]=W?g.image[Z].image:g.image[Z],te[Z]=be(g,te[Z]);const Ee=te[0],Se=r.convert(g.format,g.colorSpace),ue=r.convert(g.type),Ae=T(g.internalFormat,Se,ue,g.colorSpace),L=g.isVideoTexture!==!0,de=A.__version===void 0||Y===!0,se=Q.dataReady;let oe=D(g,Ee);Ge(i.TEXTURE_CUBE_MAP,g);let ne;if(ce){L&&de&&t.texStorage2D(i.TEXTURE_CUBE_MAP,oe,Ae,Ee.width,Ee.height);for(let Z=0;Z<6;Z++){ne=te[Z].mipmaps;for(let _e=0;_e<ne.length;_e++){const Ne=ne[_e];g.format!==fn?Se!==null?L?se&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_e,0,0,Ne.width,Ne.height,Se,Ne.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_e,Ae,Ne.width,Ne.height,0,Ne.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?se&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_e,0,0,Ne.width,Ne.height,Se,ue,Ne.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_e,Ae,Ne.width,Ne.height,0,Se,ue,Ne.data)}}}else{if(ne=g.mipmaps,L&&de){ne.length>0&&oe++;const Z=De(te[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,oe,Ae,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(W){L?se&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,te[Z].width,te[Z].height,Se,ue,te[Z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ae,te[Z].width,te[Z].height,0,Se,ue,te[Z].data);for(let _e=0;_e<ne.length;_e++){const ct=ne[_e].image[Z].image;L?se&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_e+1,0,0,ct.width,ct.height,Se,ue,ct.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_e+1,Ae,ct.width,ct.height,0,Se,ue,ct.data)}}else{L?se&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Se,ue,te[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ae,Se,ue,te[Z]);for(let _e=0;_e<ne.length;_e++){const Ne=ne[_e];L?se&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_e+1,0,0,Se,ue,Ne.image[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,_e+1,Ae,Se,ue,Ne.image[Z])}}}m(g)&&f(i.TEXTURE_CUBE_MAP),A.__version=Q.version,g.onUpdate&&g.onUpdate(g)}S.__version=g.version}function me(S,g,B,Y,Q,A){const X=r.convert(B.format,B.colorSpace),$=r.convert(B.type),le=T(B.internalFormat,X,$,B.colorSpace),ce=n.get(g),W=n.get(B);if(W.__renderTarget=g,!ce.__hasExternalTextures){const te=Math.max(1,g.width>>A),Ee=Math.max(1,g.height>>A);Q===i.TEXTURE_3D||Q===i.TEXTURE_2D_ARRAY?t.texImage3D(Q,A,le,te,Ee,g.depth,0,X,$,null):t.texImage2D(Q,A,le,te,Ee,0,X,$,null)}t.bindFramebuffer(i.FRAMEBUFFER,S),pe(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,Q,W.__webglTexture,0,Qe(g)):(Q===i.TEXTURE_2D||Q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,Q,W.__webglTexture,A),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Le(S,g,B){if(i.bindRenderbuffer(i.RENDERBUFFER,S),g.depthBuffer){const Y=g.depthTexture,Q=Y&&Y.isDepthTexture?Y.type:null,A=w(g.stencilBuffer,Q),X=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,$=Qe(g);pe(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,$,A,g.width,g.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,$,A,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,A,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,X,i.RENDERBUFFER,S)}else{const Y=g.textures;for(let Q=0;Q<Y.length;Q++){const A=Y[Q],X=r.convert(A.format,A.colorSpace),$=r.convert(A.type),le=T(A.internalFormat,X,$,A.colorSpace),ce=Qe(g);B&&pe(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,ce,le,g.width,g.height):pe(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ce,le,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,le,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ye(S,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,S),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Y=n.get(g.depthTexture);Y.__renderTarget=g,(!Y.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),V(g.depthTexture,0);const Q=Y.__webglTexture,A=Qe(g);if(g.depthTexture.format===ma)pe(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Q,0,A):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Q,0);else if(g.depthTexture.format===xa)pe(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Q,0,A):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Q,0);else throw new Error("Unknown depthTexture format")}function Ve(S){const g=n.get(S),B=S.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==S.depthTexture){const Y=S.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),Y){const Q=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,Y.removeEventListener("dispose",Q)};Y.addEventListener("dispose",Q),g.__depthDisposeCallback=Q}g.__boundDepthTexture=Y}if(S.depthTexture&&!g.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");const Y=S.texture.mipmaps;Y&&Y.length>0?ye(g.__webglFramebuffer[0],S):ye(g.__webglFramebuffer,S)}else if(B){g.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[Y]),g.__webglDepthbuffer[Y]===void 0)g.__webglDepthbuffer[Y]=i.createRenderbuffer(),Le(g.__webglDepthbuffer[Y],S,!1);else{const Q=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,A=g.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,A),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,A)}}else{const Y=S.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),Le(g.__webglDepthbuffer,S,!1);else{const Q=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,A=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,A),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,A)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Je(S,g,B){const Y=n.get(S);g!==void 0&&me(Y.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&Ve(S)}function Fe(S){const g=S.texture,B=n.get(S),Y=n.get(g);S.addEventListener("dispose",P);const Q=S.textures,A=S.isWebGLCubeRenderTarget===!0,X=Q.length>1;if(X||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=g.version,s.memory.textures++),A){B.__webglFramebuffer=[];for(let $=0;$<6;$++)if(g.mipmaps&&g.mipmaps.length>0){B.__webglFramebuffer[$]=[];for(let le=0;le<g.mipmaps.length;le++)B.__webglFramebuffer[$][le]=i.createFramebuffer()}else B.__webglFramebuffer[$]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){B.__webglFramebuffer=[];for(let $=0;$<g.mipmaps.length;$++)B.__webglFramebuffer[$]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(X)for(let $=0,le=Q.length;$<le;$++){const ce=n.get(Q[$]);ce.__webglTexture===void 0&&(ce.__webglTexture=i.createTexture(),s.memory.textures++)}if(S.samples>0&&pe(S)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let $=0;$<Q.length;$++){const le=Q[$];B.__webglColorRenderbuffer[$]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[$]);const ce=r.convert(le.format,le.colorSpace),W=r.convert(le.type),te=T(le.internalFormat,ce,W,le.colorSpace,S.isXRRenderTarget===!0),Ee=Qe(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ee,te,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+$,i.RENDERBUFFER,B.__webglColorRenderbuffer[$])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),Le(B.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(A){t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Ge(i.TEXTURE_CUBE_MAP,g);for(let $=0;$<6;$++)if(g.mipmaps&&g.mipmaps.length>0)for(let le=0;le<g.mipmaps.length;le++)me(B.__webglFramebuffer[$][le],S,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+$,le);else me(B.__webglFramebuffer[$],S,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0);m(g)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(X){for(let $=0,le=Q.length;$<le;$++){const ce=Q[$],W=n.get(ce);let te=i.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(te=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(te,W.__webglTexture),Ge(te,ce),me(B.__webglFramebuffer,S,ce,i.COLOR_ATTACHMENT0+$,te,0),m(ce)&&f(te)}t.unbindTexture()}else{let $=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&($=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture($,Y.__webglTexture),Ge($,g),g.mipmaps&&g.mipmaps.length>0)for(let le=0;le<g.mipmaps.length;le++)me(B.__webglFramebuffer[le],S,g,i.COLOR_ATTACHMENT0,$,le);else me(B.__webglFramebuffer,S,g,i.COLOR_ATTACHMENT0,$,0);m(g)&&f($),t.unbindTexture()}S.depthBuffer&&Ve(S)}function ot(S){const g=S.textures;for(let B=0,Y=g.length;B<Y;B++){const Q=g[B];if(m(Q)){const A=E(S),X=n.get(Q).__webglTexture;t.bindTexture(A,X),f(A),t.unbindTexture()}}}const C=[],ke=[];function He(S){if(S.samples>0){if(pe(S)===!1){const g=S.textures,B=S.width,Y=S.height;let Q=i.COLOR_BUFFER_BIT;const A=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=n.get(S),$=g.length>1;if($)for(let ce=0;ce<g.length;ce++)t.bindFramebuffer(i.FRAMEBUFFER,X.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,X.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,X.__webglMultisampledFramebuffer);const le=S.texture.mipmaps;le&&le.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,X.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,X.__webglFramebuffer);for(let ce=0;ce<g.length;ce++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(Q|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(Q|=i.STENCIL_BUFFER_BIT)),$){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,X.__webglColorRenderbuffer[ce]);const W=n.get(g[ce]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,W,0)}i.blitFramebuffer(0,0,B,Y,0,0,B,Y,Q,i.NEAREST),l===!0&&(C.length=0,ke.length=0,C.push(i.COLOR_ATTACHMENT0+ce),S.depthBuffer&&S.resolveDepthBuffer===!1&&(C.push(A),ke.push(A),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,ke)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,C))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),$)for(let ce=0;ce<g.length;ce++){t.bindFramebuffer(i.FRAMEBUFFER,X.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,X.__webglColorRenderbuffer[ce]);const W=n.get(g[ce]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,X.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,W,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,X.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){const g=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Qe(S){return Math.min(a.maxSamples,S.samples)}function pe(S){const g=n.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Ye(S){const g=s.render.frame;d.get(S)!==g&&(d.set(S,g),S.update())}function be(S,g){const B=S.colorSpace,Y=S.format,Q=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||B!==Hi&&B!==Kn&&($e.getTransfer(B)===at?(Y!==fn||Q!==vn)&&Ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):gt("WebGLTextures: Unsupported texture color space:",B)),g}function De(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(c.width=S.naturalWidth||S.width,c.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(c.width=S.displayWidth,c.height=S.displayHeight):(c.width=S.width,c.height=S.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=k,this.setTexture2D=V,this.setTexture2DArray=j,this.setTexture3D=ee,this.setTextureCube=H,this.rebindTextures=Je,this.setupRenderTarget=Fe,this.updateRenderTargetMipmap=ot,this.updateMultisampleRenderTarget=He,this.setupDepthRenderbuffer=Ve,this.setupFrameBufferTexture=me,this.useMultisampledRTT=pe}function u0(i,e){function t(n,a=Kn){let r;const s=$e.getTransfer(a);if(n===vn)return i.UNSIGNED_BYTE;if(n===Zs)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Js)return i.UNSIGNED_SHORT_5_5_5_1;if(n===$l)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Zl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Yl)return i.BYTE;if(n===jl)return i.SHORT;if(n===fa)return i.UNSIGNED_SHORT;if(n===$s)return i.INT;if(n===ui)return i.UNSIGNED_INT;if(n===gn)return i.FLOAT;if(n===qi)return i.HALF_FLOAT;if(n===Jl)return i.ALPHA;if(n===Ql)return i.RGB;if(n===fn)return i.RGBA;if(n===ma)return i.DEPTH_COMPONENT;if(n===xa)return i.DEPTH_STENCIL;if(n===Qs)return i.RED;if(n===eo)return i.RED_INTEGER;if(n===to)return i.RG;if(n===no)return i.RG_INTEGER;if(n===io)return i.RGBA_INTEGER;if(n===ja||n===$a||n===Za||n===Ja)if(s===at)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ja)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===$a)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Za)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ja)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ja)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===$a)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Za)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ja)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===xs||n===gs||n===_s||n===vs)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===xs)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===gs)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===_s)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===vs)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ys||n===Ms||n===bs)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ys||n===Ms)return s===at?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===bs)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ss||n===Ts||n===Es||n===ws||n===As||n===Cs||n===Rs||n===Ps||n===Ls||n===Ds||n===Is||n===Us||n===Ns||n===Fs)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ss)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ts)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Es)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ws)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===As)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Cs)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Rs)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ps)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ls)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ds)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Is)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Us)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ns)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Fs)return s===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Bs||n===ks||n===Os)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Bs)return s===at?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ks)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Os)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===zs||n===Gs||n===Vs||n===Hs)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===zs)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Gs)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Vs)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Hs)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===pa?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const f0=`
void main() {
