...
h=e[g].apply(this,h);if(!(typeof h=="undefined"?true:h))break}return d})},submit:function(a){return this.each(function(){if(f.isFunction(a))K(this,"onsubmit",a);else this.submit&&this.submit()})}};if(i.addEventListener)q=function(){i.removeEventListener("DOMContentLoaded",q,false);f.ready()};else if(i.attachEvent)q=function(){if(i.readyState==="complete"){i.detachEvent("onreadystatechange",q);f.ready()}};if(!N){N=true;if(i.readyState==="complete")f.ready();else if(i.addEventListener){i.addEventListener("DOMContentLoaded",
...
(function() {
  this.Dosbox = (function() {
    ...
    Dosbox.prototype.downloadScript = function() {
      ...
      return new Dosbox.Xhr('./vendor/js-dos-v3.js', {
        success: (function(_this) {
